...
module.exports = (client , message) => {
  ...
  setTimeout(() => {
    message.delete();
    client.channels.cache.get("831427181086769182").send(new MessageEmbed().setTitle(`Commande: ${command.help.name}`).setDescription(message.content).setFooter(`De ${message.author.tag} | ${message.author.id}`));
